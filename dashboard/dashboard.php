...
//FUNGSI CEK LOGIN
if (!((isset($_COOKIE['Cookie_1_Dashboard_Rizgold'])) and (isset($_COOKIE['Cookie_2_Dashboard_Rizgold'])) and (isset($_COOKIE['Cookie_3_Dashboard_Rizgold'])))) {
    ...
    $cek_login_Id_User = $a_hash->decode($_COOKIE['Cookie_1_Dashboard_Rizgold'], "Id_User");
    $cek_login_Password = $a_hash->decode($_COOKIE['Cookie_2_Dashboard_Rizgold'], "Password");
    $cek_login_Login_Sebagai = $a_hash->decode($_COOKIE['Cookie_3_Dashboard_Rizgold'], "Login_Sebagai");
