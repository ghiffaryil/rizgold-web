...
if (isset($_POST['submit_simpan'])) {
    ...
    // BACA DATA TERAKHIR
    $a_result_terbaru = $a_tambah_baca_update_hapus->baca_data_terbaru("tb_pengaturan_sk_kemitraan", "Id_Pengaturan_SK_Kemitraan");
    if ($a_result_terbaru['Status'] == "Sukses") {
        $Id_Auto_Increment = $a_result_terbaru['Hasil'][0]['Id_Pengaturan_SK_Kemitraan'] + 1;
    } else {
        $Id_Auto_Increment = 1;
    }
    ...
    $result = $a_tambah_baca_update_hapus->tambah_data("tb_pengaturan_sk_kemitraan", $form_field, $form_value);

    if ($result['Status'] == "Sukses") {

        // INSERT FOTO
        if ($_FILES['File_Syarat_Dan_Ketentuan']['size'] <> 0 && $_FILES['File_Syarat_Dan_Ketentuan']['error'] == 0) {
            ...
            $nama_file_upload = $a_hash->hash_nama_file($Id_Auto_Increment, "_File_Syarat_Dan_Ketentuan") . "_" . $Id_Auto_Increment . "_File_Syarat_Dan_Ketentuan";
            ...
            if ($result_upload_file['Status'] == "Sukses") {
                $form_field = array("File_Syarat_Dan_Ketentuan");
                $form_value = array("$nama_file_upload.$ext_file_upload");
                $form_field_where = array("Id_Pengaturan_SK_Kemitraan");
                $form_criteria_where = array("=");
                $form_value_where = array("$Id_Auto_Increment");
                $form_connector_where = array("");

                $result = $a_tambah_baca_update_hapus->update_data("tb_pengaturan_sk_kemitraan", $form_field, $form_value, $form_field_where, $form_criteria_where, $form_value_where, $form_connector_where);
            }
        }
...
if (isset($_GET['hapus_data_ke_tong_sampah'])) {
    ...
    $result = $a_tambah_baca_update_hapus->hapus_data_ke_tong_sampah("tb_pengaturan_sk_kemitraan", "Id_Pengaturan_SK_Kemitraan", $Get_Id_Primary);
...
if (isset($_GET['arsip_data'])) {
    ...
    $result = $a_tambah_baca_update_hapus->arsip_data("tb_pengaturan_sk_kemitraan", "Id_Pengaturan_SK_Kemitraan", $Get_Id_Primary);
...
if (isset($_GET['restore_data_dari_tong_sampah'])) {
    ...
    $result = $a_tambah_baca_update_hapus->restore_data_dari_tong_sampah("tb_pengaturan_sk_kemitraan", "Id_Pengaturan_SK_Kemitraan", $Get_Id_Primary);
...
if (isset($_GET['hapus_data_permanen'])) {
    ...
    $result = $a_tambah_baca_update_hapus->hapus_data_permanen("tb_pengaturan_sk_kemitraan", "Id_Pengaturan_SK_Kemitraan", $Get_Id_Primary);
    if ($result['Status'] == "Sukses") {
        echo "<script>document.location.href='$kehalaman'</script>";
    } else {
        echo "<script>alert('Terjadi Kesalahan Saat Menghapus Data');document.location.href='$kehalaman'</script>";
...
$hitung_Aktif = $a_tambah_baca_update_hapus->hitung_data_dengan_filter("tb_pengaturan_sk_kemitraan", $count_field_where, $count_criteria_where, $count_value_where, $count_connector_where);
$hitung_Aktif = $hitung_Aktif['Hasil'];

#-----------------------------------------------------------------------------------
#HITUNG TERARSIP
$count_value_where = array("Terarsip");
$hitung_Terarsip = $a_tambah_baca_update_hapus->hitung_data_dengan_filter("tb_pengaturan_sk_kemitraan", $count_field_where, $count_criteria_where, $count_value_where, $count_connector_where);
$hitung_Terarsip = $hitung_Terarsip['Hasil'];

#-----------------------------------------------------------------------------------
#HITUNG TERHAPUS
$count_value_where = array("Terhapus");
$hitung_Terhapus = $a_tambah_baca_update_hapus->hitung_data_dengan_filter("tb_pengaturan_sk_kemitraan", $count_field_where, $count_criteria_where, $count_value_where, $count_connector_where);
