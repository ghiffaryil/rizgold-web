...
// if (isset($_GET['edit'])) {
$result = $a_tambah_baca_update_hapus->baca_data_id("tb_pengaturan_rekening", "Id_Pengaturan_Rekening", $Get_Id_Primary);
...
if (isset($_POST['submit_simpan'])) {
    ...
    // BACA DATA TERAKHIR
    $a_result_terbaru = $a_tambah_baca_update_hapus->baca_data_terbaru("tb_pengaturan_rekening", "Id_Pengaturan_Rekening");
    if ($a_result_terbaru['Status'] == "Sukses") {
        $Id_Auto_Increment = $a_result_terbaru['Hasil'][0]['Id_Pengaturan_Rekening'] + 1;
    } else {
        $Id_Auto_Increment = 1;
    }
    ...
    $form_value = array(
        ...
        "$_POST[Nama_Pemilik_Rekening]",
        "$Waktu_Sekarang",
        "$Waktu_Sekarang",
        "Aktif"
    );

    $result = $a_tambah_baca_update_hapus->tambah_data("tb_pengaturan_rekening", $form_field, $form_value);
...
if (isset($_POST['submit_update'])) {
    ...
    $form_field_where = array("Id_Pengaturan_Rekening");
    $form_criteria_where = array("=");
    $form_value_where = array("$Get_Id_Primary");
    $form_connector_where = array("");

    $result = $a_tambah_baca_update_hapus->update_data("tb_pengaturan_rekening", $form_field, $form_value, $form_field_where, $form_criteria_where, $form_value_where, $form_connector_where);
...
if (isset($_GET['hapus_data_ke_tong_sampah'])) {
    ...
    $result = $a_tambah_baca_update_hapus->hapus_data_ke_tong_sampah("tb_pengaturan_rekening", "Id_Pengaturan_Rekening", $Get_Id_Primary);
...
if (isset($_GET['arsip_data'])) {
    ...
    $result = $a_tambah_baca_update_hapus->arsip_data("tb_pengaturan_rekening", "Id_Pengaturan_Rekening", $Get_Id_Primary);
...
if (isset($_GET['restore_data_dari_tong_sampah'])) {
    ...
    $result = $a_tambah_baca_update_hapus->restore_data_dari_tong_sampah("tb_pengaturan_rekening", "Id_Pengaturan_Rekening", $Get_Id_Primary);
...
if (isset($_GET['hapus_data_permanen'])) {
    ...
    $result = $a_tambah_baca_update_hapus->hapus_data_permanen("tb_pengaturan_rekening", "Id_Pengaturan_Rekening", $Get_Id_Primary);
    if ($result['Status'] == "Sukses") {
        echo "<script>document.location.href='$kehalaman'</script>";
    } else {
        echo "<script>alert('Terjadi Kesalahan Saat Menghapus Data');document.location.href='$kehalaman'</script>";
...
$hitung_Aktif = $a_tambah_baca_update_hapus->hitung_data_dengan_filter("tb_pengaturan_rekening", $count_field_where, $count_criteria_where, $count_value_where, $count_connector_where);
$hitung_Aktif = $hitung_Aktif['Hasil'];

#-----------------------------------------------------------------------------------
#HITUNG TERARSIP
$count_value_where = array("Terarsip");
$hitung_Terarsip = $a_tambah_baca_update_hapus->hitung_data_dengan_filter("tb_pengaturan_rekening", $count_field_where, $count_criteria_where, $count_value_where, $count_connector_where);
$hitung_Terarsip = $hitung_Terarsip['Hasil'];

#-----------------------------------------------------------------------------------
#HITUNG TERHAPUS
$count_value_where = array("Terhapus");
$hitung_Terhapus = $a_tambah_baca_update_hapus->hitung_data_dengan_filter("tb_pengaturan_rekening", $count_field_where, $count_criteria_where, $count_value_where, $count_connector_where);
...
class Search_Controller
{
    ...
    public function select_search_filter($filter_status = "Aktif", $filter = "")
    {
        ...
        $result = $a_tambah_baca_update_hapus->baca_data_dengan_filter("tb_pengaturan_rekening", $search_field_where, $search_criteria_where, $search_value_where, $search_connector_where);
