<?php
include "controller/artikel/controller_artikel.php";
?>
										...
										<div class="row">
											...
											<div class="form-group row">
												...
												<div class="col-lg-9">
													...
													?>
															<img src="media/artikel/<?php echo $edit['Foto_Artikel'] ?>?time=<?php echo $Waktu_Sekarang ?>" style="width: 300px; height: auto" alt="Foto Artikel" accept="image/png, image/gif, image/jpeg, image/webp">
															<br><br>
