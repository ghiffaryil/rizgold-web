<?php
include "controller/faq/controller_faq.php";
?>
										...
										<div class="row">
											...
											<div class="col-md-12">
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<textarea class="form-control" name="Pertanyaan"><?php if ((isset($_POST['submit_simpan'])) or (isset($_POST['submit_update']))) {
																												echo $_POST['Pertanyaan'];
																											} elseif (isset($_GET['edit'])) {
																												echo $edit['Pertanyaan'];
																											} ?></textarea>
													</div>
												</div>
											</div>
											...
											<div class="col-md-12">
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<textarea class="form-control" rows="3" name="Jawaban"><?php if ((isset($_POST['submit_simpan'])) or (isset($_POST['submit_update']))) {
																													echo $_POST['Jawaban'];
																												} elseif (isset($_GET['edit'])) {
																													echo $edit['Jawaban'];
																												} ?></textarea>
