...
setcookie("Cookie_1_Dashboard_Rizgold", "", time() + (86400 * 365));
setcookie("Cookie_2_Dashboard_Rizgold", "", time() + (86400 * 365));
setcookie("Cookie_3_Dashboard_Rizgold", "", time() + (86400 * 365));
...
if (isset($_POST['submit_login'])) {
	...
	if ($result['Status'] == "Sukses") {
		...
		setcookie("Cookie_1_Dashboard_Rizgold", $Id_User, time() + (86400 * 365)); //LOGIN ID_PENGGUNA
		setcookie("Cookie_2_Dashboard_Rizgold", $Password, time() + (86400 * 365)); //LOGIN PASSWORD
		setcookie("Cookie_3_Dashboard_Rizgold", $Login_Sebagai, time() + (86400 * 365)); //LOGIN SEBAGAI
...
<body class="hold-transition theme-primary" style="background:#000">
				...
				<div class="row justify-content-center g-0">
					<div class="col-lg-4 col-md-4 col-12">
						<div class="bg-white rounded10 shadow-lg">
							<center class="pt-4">
								<img src="../frontend/images/logo/logo_square.png" alt="" style="height:100%; width:60%;">
							</center>
							<div class="content-top-agile p-20 pb-0">
								<h2 style="color: #9f7a0c;">Login Admin RIZGOLD</font>
								</h2>
								...
								<form action="" method="POST">
									...
									<div class="row">
										<div class="col-12 text-center">
											<button type="submit" name="submit_login" class="btn btn-warning btn-block"  style="width: 100%;">Login</button>
										</div>
									</div>
								</form>
							</div>
