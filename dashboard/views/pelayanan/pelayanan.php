...
if (isset($_POST['submit_simpan'])) {
    if ($cek_required == "Sukses") {
        ...
        $Kategori = is_array($_POST['Kategori']) ? implode(",", $_POST['Kategori']) : $_POST['Kategori'];
    ...
    <div class="container-full">
        ...
        <div class="content-header">
            <div class="d-flex align-items-center">
                <div class="me-auto">
                    <h3 class="page-title">Layanan / Produk</h3>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9">
                                                        ...
                                                        <select name="Kategori[]" id="choices-multiple-remove-button" class="form-select" multiple>
                                                            <?php
                                                            ...
                                                            if ($result_kategori['Status'] == "Sukses") {
                                                                ...
                                                                foreach ($data_hasil_kategori as $data_kategori) {
                                                                    $selected = isset($_GET['edit']) && in_array($data_kategori['Id_Pelayanan_Kategori'], explode(",", $edit['Kategori'])) ? "selected" : "";
                                                            ?>
                                                                    <option value="<?php echo $data_kategori['Id_Pelayanan_Kategori']; ?>" <?php echo $selected ?>><?php echo $data_kategori['Nama_Pelayanan_Kategori']; ?></option>
                                                            <?php
                                                                }
                                                            }
                                                            ?>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <input type="text" class="form-control" name="Fasilitas" value="<?php if ((isset($_POST['submit_simpan'])) or (isset($_POST['submit_update']))) {
                                                                                                                            ...
                                                                                                                            echo "Obat Lambung; Obat Magh; Obat Gerd";
                                                                                                                        } ?>">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php
                                                                ...
                                                                $kategori_ids = explode(",", $data['Kategori']);
                                                                $kategori_names = array();

                                                                foreach ($kategori_ids as $kategori_id) {
                                                                    $result_kategori = $a_tambah_baca_update_hapus->baca_data_id("tb_pelayanan_kategori", "Id_Pelayanan_Kategori", $kategori_id);

                                                                    if ($result_kategori['Status'] == "Sukses") {
                                                                        $data_kategori = $result_kategori['Hasil'];
                                                                        $kategori_names[] = $data_kategori['Nama_Pelayanan_Kategori'];
                                                                    }
                                                                }

                                                                echo implode(", <br>", $kategori_names);
