...
if (isset($_POST['submit_simpan'])) {
    if ($cek_required == "Sukses") {
        ...
        $result = $a_tambah_baca_update_hapus->tambah_data("tb_pesan", $form_field, $form_value);

        if ($result['Status'] == "Sukses") {

            $a_result_terbaru = $a_tambah_baca_update_hapus->baca_data_terbaru("tb_pesan", "Id_Pesan");
...
if (isset($_GET['edit'])) {
    ...
    $result = $a_tambah_baca_update_hapus->baca_data_id("tb_pesan", "Id_Pesan", $Get_Id_Primary);
...
if (isset($_POST['submit_update'])) {
    if ($cek_required == "Sukses") {
        ...
        $form_field_where = array("Id_Pesan");
        $form_criteria_where = array("=");
        $form_value_where = array("$Get_Id_Primary");
        $form_connector_where = array("");

        $result = $a_tambah_baca_update_hapus->update_data("tb_pesan", $form_field, $form_value, $form_field_where, $form_criteria_where, $form_value_where, $form_connector_where);
...
if (isset($_GET['hapus_data_ke_tong_sampah'])) {
    ...
    $result = $a_tambah_baca_update_hapus->hapus_data_ke_tong_sampah("tb_pesan", "Id_Pesan", $Get_Id_Primary);
...
if (isset($_GET['arsip_data'])) {
    ...
    $result = $a_tambah_baca_update_hapus->arsip_data("tb_pesan", "Id_Pesan", $Get_Id_Primary);
...
if (isset($_GET['restore_data_dari_arsip'])) {
    ...
    $result = $a_tambah_baca_update_hapus->restore_data_dari_arsip("tb_pesan", "Id_Pesan", $Get_Id_Primary);
...
if (isset($_GET['restore_data_dari_tong_sampah'])) {
    ...
    $result = $a_tambah_baca_update_hapus->restore_data_dari_tong_sampah("tb_pesan", "Id_Pesan", $Get_Id_Primary);
...
if (isset($_GET['hapus_data_permanen'])) {
    ...
    // READ DATA
    $result_data = $a_tambah_baca_update_hapus->baca_data_id("tb_pesan", "Id_Pesan", $Get_Id_Primary);
...
$hitung_Aktif = $a_tambah_baca_update_hapus->hitung_data_dengan_filter("tb_pesan", $count_field_where, $count_criteria_where, $count_value_where, $count_connector_where);
$hitung_Aktif = $hitung_Aktif['Hasil'];
//DATA TERARSIP
$count_value_where = array("Terarsip");
$hitung_Terarsip = $a_tambah_baca_update_hapus->hitung_data_dengan_filter("tb_pesan", $count_field_where, $count_criteria_where, $count_value_where, $count_connector_where);
$hitung_Terarsip = $hitung_Terarsip['Hasil'];
//DATA TERHAPUS (SAMPAH)
$count_value_where = array("Terhapus");
$hitung_Terhapus = $a_tambah_baca_update_hapus->hitung_data_dengan_filter("tb_pesan", $count_field_where, $count_criteria_where, $count_value_where, $count_connector_where);
                                ...
                                <div class="table-responsive">
                                    <table id="example1" class="table table-bordered" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            $result = $a_tambah_baca_update_hapus->baca_data_dengan_filter("tb_pesan", $search_field_where, $search_criteria_where, $search_value_where, $search_connector_where);
                                            ...
                                            if ($result['Status'] == "Sukses") {
                                                ...
                                                foreach ($data_hasil as $data) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo $kehalaman ?>&edit&id=<?php echo $a_hash->encode($data["Id_Pesan"], $_GET['menu']); ?>">
                                                                <?php echo $data['Nama'] ?>
                                                            </a>
                                                        </td>
                                                        <td><a href="mailto:<?php echo $data['Email']; ?>" target="_blank" class="text-muted"><u><?php echo $data['Email'] ?></u></a></td>
                                                        <td><?php echo $data['Nomor_Handphone'] ?></td>
                                                        <td><?php echo $data['Instansi'] ?></td>
                                                        <td><?php echo $data['Pesan'] ?></td>
                                                        <td>
                                                            <?php if($data['Follow_Up'] == "Sudah"){
                                                                $color = "success";
                                                            }else{
                                                                $color = "danger";
                                                            } ?>

                                                            <span class="badge badge-<?php echo $color?>"><?php echo $data['Follow_Up']?></span>
                                                        </td>
                                                    </tr>
                                                <?php } ?>
                                            <?php } ?>
