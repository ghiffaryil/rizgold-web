    ...
    <nav class="navbar navbar-expand-lg navigation fixed-top" id="navbar" style="padding: 0 10px 0 0; background: #131521;">
        <div class="container">
            <a class="navbar-brand" href="index.php">
                <img src="frontend/images/logo/logo_square.png" class="logo-navbar">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarmain">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item <?php if (!isset($_GET['view'])) {
                                            echo "active";
                    ...
                    <li class="nav-item <?php if (isset($_GET['view']) and $_GET['view'] == "article") {
                                            echo "active";
                                        } ?>"><a class="nav-link" href="?view=article">Artikel</a></li>
                    <li class="nav-item <?php if (isset($_GET['view']) and $_GET['view'] == "contact") {
                                            echo "active";
                                        } ?>"><a class="nav-link" href="?view=contact">Kontak</a></li>
