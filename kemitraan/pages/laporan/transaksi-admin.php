                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        ?>
                                            ...
                                            <?php if ($edit['File_Bukti_Transaksi'] != "") { ?>
                                                <span class="text-primary">Transaksi ini memiliki Bukti Transfer</span><br>
<br>
                                            ...
                                            <?php } else { ?>
                                                <span class="badge badge-light-danger">Transaksi ini tidak memiliki Bukti Transfer</span>
                                            <?php } ?>
                                        <?php } ?>
                                    </div>
                                    <div class="col-lg-6">
...
<script>
    ...
    function function_select_produk(val) {
        <?php if(isset($_GET['edit'])){?> var customSelectValue = "" <?php } ?>
