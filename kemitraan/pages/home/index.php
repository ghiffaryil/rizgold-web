...
<div class="app-content">
    <div class="card card-flush">
        <?php
        // CEK SALDO
        $search_field_where = array("Id_Pengguna", "Keterangan");
        $search_criteria_where = array("=", "=");
        $search_value_where = array("$u_Id_Pengguna", "Pertama");
        $search_connector_where = array("AND", "ORDER BY Id_Top_Up_Saldo DESC LIMIT 1");
        ...
        ?>
            ...
            if ($data_saldo['Status_Saldo'] == "Rejected") {
            ?>
                <div class="text-center mt-5">
                    <span class="badge badge-danger">
                        <h1 class="fs-1x text-white">Oops! Top-Up Saldo anda <b class="">Ditolak</b> oleh Admin</h1>
                    </span>
                    <hr>
                    <div class="m-6t">
            ...
            <div class="mt-10">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center flex-column">
                        <form method="POST" enctype="multipart/form-data">
                            <input type="hidden" readonly name="Saldo" id="saldo">
                            <input type="hidden" readonly id="input_generate_code" name="Kode_Unik">
                            <input type="hidden" readonly name="Keterangan" value="Pertama">
