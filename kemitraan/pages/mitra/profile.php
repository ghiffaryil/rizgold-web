                ...
                <div class="flex-lg-row-fluid ms-lg-15">
                    <div class="card pt-4 mb-6 mb-xl-9">
                        <div class="card-header border-0">
                            <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-semibold mb-8">
                                <li class="nav-item">
                                    <a class="nav-link text-active-primary pb-4 active" data-bs-toggle="tab" href="#kt_user_profile_tab">Edit Profile</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link text-active-primary pb-4" data-kt-countup-tabs="true" data-bs-toggle="tab" href="#kt_user_edit_password">Edit Password</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="card pt-4 mb-6 mb-xl-9">
                        <div class="tab-content" id="myTabContent">
                                ...
                                <div class="card mb-xl-9">
                                    ...
                                    <div class="card-body pt-0 pb-5">
                                        <form action="" method="POST">
                                            ...
                                            <div class="mb-7">
                                                <label class="required fw-semibold fs-6 mb-2">No_Handphone</label>
                            ...
                            <div class="tab-pane fade" id="kt_user_edit_password" role="tabpanel">
                                <div class="card-header border-0">
                                    <div class="card-title">
                                        <h2>Edit Password</h2>
                                    </div>
