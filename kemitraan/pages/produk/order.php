...
<div id="kt_app_content" class="app-content  pb-0 ">
    ...
    <div class="d-flex flex-column gap-7 gap-lg-10">
        <div class="d-flex flex-wrap flex-stack gap-5 gap-lg-10">
            ...
            <!--begin::Button-->
            <a href="/oswald-html-pro/apps/ecommerce/sales/listing.html" class="btn btn-icon btn-light btn-active-secondary btn-sm ms-auto me-lg-n7">
                <i class="ki-duotone ki-left fs-2"></i> </a>
            <!--end::Button-->

            <!--begin::Button-->
            <a href="/oswald-html-pro/apps/ecommerce/sales/edit-order.html" class="btn btn-success btn-sm me-lg-n7">Edit Order</a>
            <!--end::Button-->

            <!--begin::Button-->
            <a href="/oswald-html-pro/apps/ecommerce/sales/add-order.html" class="btn btn-primary btn-sm">Add New Order</a>
            <!--end::Button-->
        </div>
        <!--begin::Order summary-->
                        ...
                        <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                            <tbody class="fw-semibold text-gray-600">
                                <tr>
                                    ...
                                    <td class="fw-bold text-end">14/09/2024</td>
                                </tr>
                                <tr>
                                    <td class="text-muted">
                                        <div class="d-flex align-items-center">
                                    ...
                                    <td class="fw-bold text-end">
                                        Online
                                        <img src="/oswald-html-pro/assets/media/svg/card-logos/visa.svg" class="w-50px ms-2" />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="text-muted">
                        ...
                        <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                            <tbody class="fw-semibold text-gray-600">
                                    ...
                                    <td class="fw-bold text-end">
                                        <div class="d-flex align-items-center justify-content-end">
                                            ...
                                            <div class="symbol symbol-circle symbol-25px overflow-hidden me-3">
                                                <a href="/oswald-html-pro/apps/ecommerce/customers/details.html">
                                                    <div class="symbol-label">
                                                        <img src="/oswald-html-pro/assets/media/avatars/300-23.jpg" alt="Dan Wilson" class="w-100" />
                                                    </div>
                                                </a>
                                            </div>
                                            <!--end::Avatar-->
                                            ...
                                            <!--begin::Name-->
                                            <a href="/oswald-html-pro/apps/ecommerce/customers/details.html" class="text-gray-600 text-hover-primary">
                                                Dan Wilson </a>
                                            <!--end::Name-->
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="fw-bold text-end">
                                        <a href="/oswald-html-pro/apps/user-management/users/view.html" class="text-gray-600 text-hover-primary">
                        ...
                        <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                            <tbody class="fw-semibold text-gray-600">
                                <tr>
                                    ...
                                    <td class="fw-bold text-end"><a href="/oswald-html-pro/apps/invoices/view/invoice-3.html" class="text-gray-600 text-hover-primary">#INV-000414</a></td>
                                </tr>
                                <tr>
                                    <td class="text-muted">
                                        <div class="d-flex align-items-center">
                                    ...
                                    <tbody class="fw-semibold text-gray-600">
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <!--begin::Thumbnail-->
                                                    <a href="/oswald-html-pro/apps/ecommerce/catalog/edit-product.html" class="symbol symbol-50px">
                                                        <span class="symbol-label" style="background-image:url(/oswald-html-pro/assets/media//stock/ecommerce/1.png);"></span>
                                                    </a>
                                                    <!--end::Thumbnail-->

                                                    <!--begin::Title-->
                                                    <div class="ms-5">
                                                        <a href="/oswald-html-pro/apps/ecommerce/catalog/edit-product.html" class="fw-bold text-gray-600 text-hover-primary">Product 1</a>
                                                        <div class="fs-7 text-muted">Delivery Date: 14/09/2024</div>
                                                    </div>
                                                    <!--end::Title-->
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <!--begin::Thumbnail-->
                                                    <a href="/oswald-html-pro/apps/ecommerce/catalog/edit-product.html" class="symbol symbol-50px">
                                                        <span class="symbol-label" style="background-image:url(/oswald-html-pro/assets/media//stock/ecommerce/100.png);"></span>
                                                    </a>
                                                    <!--end::Thumbnail-->

                                                    <!--begin::Title-->
                                                    <div class="ms-5">
                                                        <a href="/oswald-html-pro/apps/ecommerce/catalog/edit-product.html" class="fw-bold text-gray-600 text-hover-primary">Footwear</a>
                                                        <div class="fs-7 text-muted">Delivery Date: 14/09/2024</div>
                                                    </div>
                                                    <!--end::Title-->
                                                </div>
