...
if (isset($_POST['submit_tarik_saldo'])) {
    ...
    $form_value = array("$u_Id_Pengguna", "$_POST[nominal_saldo]", "Pending", "Tarik", "$Waktu_Sekarang", "$Waktu_Sekarang");
    ...
    if ($result['Status'] == "Sukses") {
        ...
        $form_value = array("Tarik", "melakukan Tarik saldo", "$_POST[nominal_saldo]", "Pending", "Kemitraan", "$Id_Auto_Increment", "$u_Id_Pengguna", "$u_Id_Pengguna", "$Waktu_Sekarang");
