...
if (isset($_GET['edit'])) {
    $result = $a_tambah_baca_update_hapus->baca_data_id("tb_pengaturan_pembelian", "Id_Pengaturan_Pembelian", $Get_Id_Primary);
...
if (isset($_POST['submit_update'])) {
    ...
    $form_field_where = array("Id_Pengaturan_Pembelian");
...
if (isset($_GET['hapus_data_ke_tong_sampah'])) {
    ...
    $result = $a_tambah_baca_update_hapus->hapus_data_ke_tong_sampah("tb_pengaturan_pembelian", "Id_Pengaturan_Pembelian", $Get_Id_Primary);
...
if (isset($_GET['arsip_data'])) {
    ...
    $result = $a_tambah_baca_update_hapus->arsip_data("tb_pengaturan_pembelian", "Id_Pengaturan_Pembelian", $Get_Id_Primary);
...
if (isset($_GET['restore_data_dari_tong_sampah'])) {
    ...
    $result = $a_tambah_baca_update_hapus->restore_data_dari_tong_sampah("tb_pengaturan_pembelian", "Id_Pengaturan_Pembelian", $Get_Id_Primary);
...
if (isset($_GET['hapus_data_permanen'])) {
    ...
    $result = $a_tambah_baca_update_hapus->hapus_data_permanen("tb_pengaturan_pembelian", "Id_Pengaturan_Pembelian", $Get_Id_Primary);
    if ($result['Status'] == "Sukses") {
        echo "<script>document.location.href='$kehalaman'</script>";
    } else {
        echo "<script>alert('Terjadi Kesalahan Saat Menghapus Data');document.location.href='$kehalaman'</script>";
