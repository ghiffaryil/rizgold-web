...
if (isset($_POST['submit_simpan'])) {
    ...
    $result = $a_tambah_baca_update_hapus->tambah_data("tb_produk_kategori", $form_field, $form_value);
...
if (isset($_POST['submit_update'])) {
    ...
    $Get_Id_Primary = $_POST['Id_Produk_Kategori'];
    ...
    $form_field_where = array("Id_Produk_Kategori");
    $form_criteria_where = array("=");
    $form_value_where = array("$Get_Id_Primary");
    $form_connector_where = array("");

    $result = $a_tambah_baca_update_hapus->update_data("tb_produk_kategori", $form_field, $form_value, $form_field_where, $form_criteria_where, $form_value_where, $form_connector_where);
...
if (isset($_GET['hapus_data_ke_tong_sampah'])) {
    ...
    $result = $a_tambah_baca_update_hapus->hapus_data_ke_tong_sampah("tb_produk_kategori", "Id_Produk_Kategori", $Get_Id_Primary);
...
if (isset($_GET['arsip_data'])) {
    ...
    $result = $a_tambah_baca_update_hapus->arsip_data("tb_produk_kategori", "Id_Produk_Kategori", $Get_Id_Primary);
...
if (isset($_GET['restore_data_dari_tong_sampah'])) {
    ...
    $result = $a_tambah_baca_update_hapus->restore_data_dari_tong_sampah("tb_produk_kategori", "Id_Produk_Kategori", $Get_Id_Primary);
...
if (isset($_GET['hapus_data_permanen'])) {
    ...
    $result = $a_tambah_baca_update_hapus->hapus_data_permanen("tb_produk_kategori", "Id_Produk_Kategori", $Get_Id_Primary);
    if ($result['Status'] == "Sukses") {
        echo "<script>document.location.href='$kehalaman'</script>";
    } else {
        echo "<script>alert('Terjadi Kesalahan Saat Menghapus Data');document.location.href='$kehalaman'</script>";
