            ...
            <div class="app-navbar">
                ...
                <div class="app-navbar-item ms-1">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px" data-kt-menu="true">
                        <!--begin::Heading-->
                        <div class="d-flex flex-column flex-center bgi-no-repeat px-9 py-5 bg-dark">
                            <!--begin::Title-->
                        ...
                        <div class="row g-0">
                            <!--begin:Item-->
                            <div class="col-6">
                                <a href="?menu=belanja" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-end border-bottom">
                                    <i class="ki-duotone ki-shop fs-3x text-primary mb-2">
                                        <span class="path1"></span>
                                        <span class="path2"></span>
                                        <span class="path3"></span>
                                        <span class="path4"></span>
                                    ...
                                    <span class="fs-5 fw-semibold text-gray-800 mb-0">Produk</span>
                                    <span class="fs-7 text-gray-400">Belanja Produk</span>
                                </a>
                            </div>
                            <!--end:Item-->
                            <!--begin:Item-->
                            <div class="col-6">
                                <a href="?menu=belanja" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-bottom">
                                    <i class="ki-duotone ki-dollar fs-3x text-success mb-2">
                                        <span class="path1"></span>
                                        <span class="path2"></span>
                                        <span class="path3"></span>
                                    </i>
                                    <span class="fs-5 fw-semibold text-gray-800 mb-0">Penjualan</span>
                                    <span class="fs-7 text-gray-400">Daftar Penjualan Saya</span>
                            ...
                            <div class="col-6">
                                <a href="../dist/apps/projects/list.html" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-end">
                                    <i class="ki-duotone ki-user-tick fs-3x text-danger mb-2">
                                        <span class="path1"></span>
                                        <span class="path2"></span>
                                        <span class="path3"></span>
                                    </i>
                                    <span class="fs-5 fw-semibold text-gray-800 mb-0">Mitra</span>
                                    <span class="fs-7 text-gray-400">Daftar Pengguna</span>
                                </a>
                            </div>
                            <!--end:Item-->
                            <!--begin:Item-->
                            <div class="col-6">
                                <a href="?menu=belanja" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light">
                                    <i class="ki-duotone ki-tablet-text-up fs-3x text-warning mb-2">
                                        <span class="path1"></span>
                                        <span class="path2"></span>
                                    </i>
                                    <span class="fs-5 fw-semibold text-gray-800 mb-0">Laporan</span>
                                    <span class="fs-7 text-gray-400">Download Laporan</span>
                                </a>
                            </div>
                            <!--end:Item-->
                        </div>
                ...
                <!--begin::Chat-->
                <div class="app-navbar-item ms-1 d-none">
                    <!--begin::Menu wrapper-->
                ...
                <div class="app-navbar-item ms-1 d-none">
                    <!--begin::Menu wrapper-->
                    <div class="btn btn-icon btn-color-white btn-active-color-primary" id="kt_drawer_shopping_cart_toggle">
                ...
                <div class="app-navbar-item ms-1 d-none">
                    <!--begin::Menu wrapper-->
                    <div class="btn btn-icon btn-color-white btn-active-color-primary" id="kt_activities_toggle">
